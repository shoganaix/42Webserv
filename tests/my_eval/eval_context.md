...
- launch the installation of siege with homebrew (for mac) - lets see for ubuntu
...
- limit the client body (use curl -X POST -H "Content-Type: plain/text" --data "BODY IS HERE write something shorter
